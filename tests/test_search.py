...
def test_bfs_basic():
    ...
    assert bfs_internet.requests == ['/wiki/Calvin_Li', '/wiki/Chinese_name', '/wiki/Chinese_surname', '/wiki/Li_(surname_%E6%9D%8E)', '/wiki/Wuhan', '/wiki/Hubei', '/wiki/Central_Academy_of_Drama', '/wiki/All_Men_Are_Brothers_(TV_series)', '/wiki/Chinese_language']
...
def test_dfs_basic():
    ...
    assert dfs_internet.requests == ['/wiki/Calvin_Li', '/wiki/Main_Page']
...
def test_dfs_complex():
    ...
    dfs_internet = Internet()
    dfs = DFSProblem(dfs_internet)
    assert dfs.dfs(source = "/wiki/Calvin_Li", goal = "/wiki/Comparison_of_microblogging_and_similar_services") == ['/wiki/Calvin_Li', '/wiki/Main_Page', '/wiki/Wikimedia_Foundation', '/wiki/VIAF_(identifier)', '/wiki/Virtual_International_Authority_File', '/wiki/Interested_Parties_Information', '/wiki/Law', '/wiki/Human_science', '/wiki/Truth', '/wiki/Verstehen', '/wiki/Phronesis', '/wiki/Knowledge', '/wiki/Max_Weber', '/wiki/Trove_(identifier)', '/wiki/Trove', '/wiki/The_Sydney_Morning_Herald', '/wiki/MBL_(identifier)', '/wiki/MusicBrainz', '/wiki/BBC_Online', '/wiki/YouView', '/wiki/List_of_student_newspapers_in_the_United_Kingdom', '/wiki/Oxford_Student_Publications_Limited', '/wiki/Facebook', '/wiki/Comparison_of_microblogging_services', '/wiki/Comparison_of_microblogging_and_similar_services']
    assert dfs_internet.requests == ['/wiki/Calvin_Li', '/wiki/Main_Page', '/wiki/Wikimedia_Foundation', '/wiki/VIAF_(identifier)', '/wiki/Virtual_International_Authority_File', '/wiki/Interested_Parties_Information', '/wiki/Law', '/wiki/Human_science', '/wiki/Truth', '/wiki/Verstehen', '/wiki/Phronesis', '/wiki/Knowledge', '/wiki/Max_Weber', '/wiki/Trove_(identifier)', '/wiki/Trove', '/wiki/The_Sydney_Morning_Herald', '/wiki/MBL_(identifier)', '/wiki/MusicBrainz', '/wiki/BBC_Online', '/wiki/YouView', '/wiki/List_of_student_newspapers_in_the_United_Kingdom', '/wiki/Oxford_Student_Publications_Limited', '/wiki/Facebook', '/wiki/Comparison_of_microblogging_services']
